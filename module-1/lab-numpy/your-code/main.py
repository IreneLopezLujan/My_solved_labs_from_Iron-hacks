...
print("No porque no coincide el tamño de las filas")
...
print("Suma 1 a todos los elementos de a.")
...
print("Si son iguales porque estamos multiplicando cada elemento por uno")
